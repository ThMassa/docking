...
\headerbox{Matériel}{name=methodologie,column=0,below=contexte,span=6}{
	...
	\begin{minipage}[t]{0.30\textwidth}
		...
		\begin{center}
			\includegraphics*[width=0.55\textwidth]{imgs/rover.jpg}
		\end{center}
	\end{minipage}
}
...
\headerbox{architecture logicielle}{name=dynamique,column=3,below=methodologie,span=3}{
	...
	\begin{center}
		\includegraphics*[width=0.9\textwidth]{imgs/schema_general.png}
	\end{center}
}

\headerbox{Conclusion}{name=conclusion,column=3,below=dynamique, span=3}{
	Ci-dessous l'algorithme essayé sur le stade de l'ENSTA.
	\begin{center}
		\includegraphics*[width=0.5\textwidth]{imgs/visu_1.png}
	\end{center}
}
