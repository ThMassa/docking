...
\begin{poster}%
	...
	\begin{minipage}[t]{0.15\linewidth}
		\centering
		\includegraphics[height=2.6em]{logo_ensta.jpg}
		
		\includegraphics[height=2.6em]{logo-lab-sticc2.png}
		\includegraphics[height=2.6em]{logo_ubs_transparent.png}
	\end{minipage}
	}	
	% Title
	...
	\\\normalsize\textsc{\textbf{\underline{ENCADRANTS :}} Ronan DOUGUET$^{(2)}$, Yvan EUSTACHE$^{(2)}$, Dominique HELLER$^{(2)}$}\vspace{0.5em}
	\\$(1)$ ENSTA Bretagne ; $(2)$ Lab STICC-UBS
	\vspace{-0.25cm}}
	% Logo2
	{\hfill
	\begin{minipage}[t]{0.15\linewidth}
		\centering
		\includegraphics[height=2.6em]{logo_isblue.jpg}
		\includegraphics[height=2.6em]{logo_edf.jpg}
		
		\includegraphics[height=2.6em]{logo_afhy.png}
	\end{minipage}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	sont utilisés les drones et tout particulièrement les AUV ou USV, l’une des grandes difficultés
	...
	en s’intéressant au cas d’un USV sur le lac.
}
...
\headerbox{Matériel}{name=methodologie,column=0,below=contexte,span=6}{
	...
	\begin{minipage}[t]{0.30\textwidth}
		...
		où nous n'avions pas accès au drone. Son utilisation est permise et cohérente, de par la similarité
		dans le manière dont sont contrôlés l'USV et le rover
		\begin{center}
			\includegraphics*[width=0.45\textwidth]{rover.jpg}
		\end{center}
	\end{minipage}
}
