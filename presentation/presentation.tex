...
\date{8 Mars 2024}
\titlegraphic{\includegraphics[width=2.5cm]{logo_ensta.jpg} \includegraphics[width=2.5cm]{logo-lab-sticc2.png} \includegraphics[width=2.5cm]{logo_ubs_transparent.png} 
\linebreak \includegraphics[width=1.5cm]{logo_afhy.png} \includegraphics[width=1.cm]{logo_edf.jpg} \includegraphics[width=1.5cm]{logo_isblue.jpg}}
