...
\begin{figure}[H]
  \resizebox{0.5\columnwidth}{!}{\includegraphics{imgs/ScreenshotCase2.png}}\resizebox{0.5\columnwidth}{!}{\includegraphics{imgs/ScreenshotCase1.png}}
...
\chapter{Annexes}
\section{Où trouver le code lié au projet}
Vous pourrez trouver le code sur le repository suivant : \href{https://github.com/ThMassa/docking}{https://github.com/ThMassa/docking}
