...
\begin{enumerate}
    ...
    La configuration du module se fait avec le logiciel \textit{U-Center} (sous Windows). Dans tous les cas, il faut que la base soit alimentée en permanence pour ne pas perdre la position acquise et que l'antenne soit bien dégagée pour une meilleure réception des signaux.
...
En cas de problème avec le logiciel (impossibilité de détecter le module ou de lire ses paramètres), il faut court-circuiter les pins \textit{RESET_N} et \textit{GND} du module pendant la configuration. Cela devrait résoudre le problème.
